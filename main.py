...
def generate_freq_table(input_txt: str) -> Dict:
    table = {}
    for i, char in enumerate(input_txt):
        ...
        if lchar not in table:
            ...
            if prev_char not in table[lchar]['neighbors']['prev']:
                table[lchar]['neighbors']['prev'][prev_char] = 1
            else:
                table[lchar]['neighbors']['prev'][prev_char] += 1

            if next_char not in table[lchar]['neighbors']['next']:
                table[lchar]['neighbors']['next'][next_char] = 1
            else:
                table[lchar]['neighbors']['next'][next_char] += 1
